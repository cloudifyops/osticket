...
<form action="tickets.php?id=<?php echo $ticket->getId(); ?>&a=edit" method="post" id="save"  enctype="multipart/form-data">
 ...
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr><td><?php echo __('User'); ?>:</td><td>
        ...
        <tr <?php echo $extDisplay ?>>
            <td width="160" > <?php echo __('Corporate name'); ?>: </td>
            <td>
                <span style="display:inline-block;">
                    <input type="text" size=45 name="corpName" id="corpName"
                        autocomplete="off" autocorrect="off" value="<?php echo $ticket->getCorpName(); ?>" /> </span>
            ...
            <td>
                <span style="display:inline-block;">
                    <input type="text" size=45 name="fdtId" id="fdtId"
                        autocomplete="off" autocorrect="off" value="<?php echo $ticket->getFdtId(); ?>" /> </span>
            ...
            <td>
                <span style="display:inline-block;">
                    <input type="text" size=45 name="policyNumber" id="policyNumber"
                        autocomplete="off" autocorrect="off" value="<?php echo $ticket->getPolicyNumber(); ?>" /> </span>
            ...
            <td>
                <span style="display:inline-block;">
                    <input type="text" size=45 name="mediId" id="mediId"
                        autocomplete="off" autocorrect="off" value="<?php echo $ticket->getMediId(); ?>" /> </span>
            ...
            <td>
                <span style="display:inline-block;">
                    <input type="text" size=45 name="employeeId" id="employeeId"
                        autocomplete="off" autocorrect="off" value="<?php echo $ticket->getEmployeeId(); ?>" /> </span>
