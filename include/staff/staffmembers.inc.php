...
if($_REQUEST['name_qs']){
    $where.=' AND (staff.firstname LIKE '.db_input("%".$_REQUEST['name_qs']."%").') || (staff.lastname LIKE '.db_input("%".$_REQUEST['name_qs']."%").')';
    $qs += array('name_qs'=>$_REQUEST['name_qs']);
}
...
<div class="pull-left" style="width:700px;">
    <form action="staff.php" method="GET" name="filter">
     <input type="hidden" name="a" value="filter" >
        ...
        <input type="text" name="name_qs" value="<?php echo $_REQUEST['name_qs']?>" placeholder="User name" />
        &nbsp;&nbsp;
