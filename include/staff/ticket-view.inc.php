...
<table width="940" cellpadding="2" cellspacing="0" border="0">
    <tr>
        <td width="20%" class="has_bottom_border">
             <h3><a href="tickets.php?id=<?php echo $ticket->getId(); ?>"
             title="<?php echo __('Reload'); ?>"><i class="icon-refresh"></i>
             <?php echo sprintf(__('Ticket #%s'), $ticket->getNumber()); ?></a></h3>
        </td>
...
<?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        <span id="user-<?php echo $ticket->getCorpName(); ?>-email"><?php echo $ticket->getCorpName(); ?></span>
                    </td>
                </tr>
                <?php }?>
                 <tr>
                    ...
                    <td>
                        <span id="user-<?php echo $ticket->getPolicyNumber(); ?>-email"><?php echo $ticket->getEmployeeId(); ?></span>
                    </td>
                </tr>
                <tr>
                ...
                <?php if($source == 'External'){?>
                <tr>
                    <th><?php echo __('MediAssist Id'); ?>:</th>
                    <td>
                        <span id="user-<?php echo $ticket->getPolicyNumber(); ?>-email"><?php echo $ticket->getMediId(); ?></span>
                    </td>
                </tr>
                <tr>
                    <th><?php echo __('Claim No'); ?>:</th>
                    <td>
                        <span id="user-<?php echo $ticket->getPolicyNumber(); ?>-email"><?php echo $ticket->getClaimNo(); ?></span>
                    </td>
                </tr>
                <tr>
                    <th><?php echo __('Policy Number'); ?>:</th>
                    <td>
                        <span id="user-<?php echo $ticket->getPolicyNumber(); ?>-email"><?php echo $ticket->getPolicyNumber(); ?></span>
                    </td>
                </tr>
                <tr>
                    <th><?php echo __('FreshDesk Ticket Id'); ?>:</th>
                    <td>
                        <span id="user-<?php echo $ticket->getFdtId(); ?>-email"><?php echo $ticket->getFdtId(); ?></span>
                    </td>
                </tr>
                <?php }?>
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
        ...
        <td width="60%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    <th width="100"><?php echo __('Issue Category');?>:</th>
