...
if($res && ($num=db_num_rows($res)))
    $showing=sprintf(_N('Showing %d issue category', 'Showing %d issue categories', $num), $num);
else
    $showing=__('No issue category found!');
...
<div class="pull-right flush-right" style="padding-top:5px;padding-right:5px;">
    <b><a href="helptopics.php?a=add" class="Icon newHelpTopic"><?php echo __('Add New Issue Category');?></a></b></div>
<div class="clear"></div>
...
<?php foreach (OsticketConfig::allTopicSortModes() as $i=>$m)
    ...
    <thead>
        <tr>
            ...
            <th style="padding-left:4px;vertical-align:middle" width="360"><?php echo __('Issue Category'); ?></th>
    ...
    <tfoot>
     <tr>
        <td colspan="7">
            ...
            <?php }else{
                echo __('No Issue Category found');
            } ?>
        </td>
     </tr>
    </tfoot>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo sprintf(__('Are you sure you want to <b>enable</b> %s?'),
            _N('selected issue category', 'selected issue categories', 2));?>
    </p>
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(__('Are you sure you want to DELETE %s?'),
            _N('selected issue category', 'selected issue categories', 2));?></strong></font>
