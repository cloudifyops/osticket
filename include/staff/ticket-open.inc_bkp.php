...
q
        ...
        <?php
            ...
            ?>
        <tr>
            <td width="160" class="required"> <?php echo __('FreshDesk Ticket ID'); ?>: </td>
            <td>
        ...
        <tr>
            <td width="160" class="required"> <?php echo __('Policy Number'); ?>: </td>
            <td>
                <span style="display:inline-block;">
                    <input type="text" size=45 name="name" id="user-name" value="<?php echo $info['name']; ?>" /> </span>
                <font class="error">* <?php echo $errors['name']; ?></font>
        ...
        <tr>
            <td width="160" class="required"> <?php echo __('MediAssist ID'); ?>: </td>
            <td>
                <span style="display:inline-block;">
                    <input type="text" size=45 name="name" id="user-name1" value="<?php echo $info['name1']; ?>" /> </span>
                <font class="error">* <?php echo $errors['name']; ?></font>
            </td>
        </tr>
	</tr>
